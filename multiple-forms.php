...
<div class="row mt-3">
    <div class="col-12">
        <h1>Form 1</h1>
        <form action="/api/index.php?result=html" method="post" id="form1">
            ...
            <div class="jqf-alerts-container">
                <div class="jqf-html-response-container mt-3"></div>
...
<div class="row mt-3">
    <div class="col-12">
        <h1>Form 2</h1>
        <form action="/api/index.php?result=html" method="post" id="form2">
            ...
            <div class="jqf-form-container">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="email" name="email" id="form2_email" class="form-control">
                </div>
                <div class="form-group mb-2">
                    <label for="form2_message">Message</label>
                    <textarea name="message" id="form2_message" class="form-control"></textarea>
                </div>
                <div class="form-group mb-2">
                    <label for="form2_action">Action</label>
                    <select class="form-control url" id="form2_action">
                        <?php require_once('actions.php'); ?>
                    </select>
                </div>
                <button type="submit" class="btn btn-primary mt-3">Submit</button>
...
<script>
    $(document).ready(function () {
        $('#form1 .url').on('change', function () {
            $('#form1').attr('action', $(this).val());
        });

        $('#form2 .url').on('change', function () {
